...
export function generateAiPrompt(
  ...
  return `
     Instruction: You are an AI programmer that extract/transform a text input to in JSON output.
     Extract the following Input Text: ${input}
     Expected JSON Output format: {"action": "restaurant_search", "parameters": {"query": "sushi", "near": "downtown Los Angeles", "price": "1", "open_now": true}}
      ...
      Note:
       ...
       - No need for json text modifier, just return the JSON format.
  `
}